...
class AuthenticatedApplyPromoCodeToCartTest extends GraphQlWithLoginTestCase
{
    ...
    public function testApplyPromoCode(string $promoCodeCode): void
    {
        ...
        $expectedTotalPriceWithoutVatAfterDiscount = (float)$totalPriceWithoutVat * 0.9;
        self::assertEquals(
            $this->getSerializedPriceConvertedToDomainDefaultCurrency((string)$expectedTotalPriceWithoutVatAfterDiscount, $vatHigh),
            $data['totalPrice']
        );
    }
