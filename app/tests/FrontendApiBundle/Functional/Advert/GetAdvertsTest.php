...
class GetAdvertsTest extends GraphQlTestCase
{
    ...
    public function testGetFooterAdverts(): void
    {
        ...
        $expectedAdvertsData = [
            array_slice($this->getExpectedAdverts(), 0, 1)[0],
            array_slice($this->getExpectedAdverts(), 2, 1)[0],
        ];
     ...
     * @return string
     */
    private function getAllAdvertsQuery(?string $positionName = null): string
    {
    ...
    private function getExpectedAdverts(): array
    {
        ...
        return [
            ...
            [
                'name' => t('Demo advert in category', [], Translator::DATA_FIXTURES_TRANSLATION_DOMAIN, $firstDomainLocale),
                'type' => Advert::TYPE_CODE,
                'categories' => [['uuid' => $categoryElectronics->getUuid()], ['uuid' => $categoryBooks->getUuid()]],
