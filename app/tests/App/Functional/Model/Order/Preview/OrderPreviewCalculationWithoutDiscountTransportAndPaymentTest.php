...
class OrderPreviewCalculationWithoutDiscountTransportAndPaymentTest extends FunctionalTestCase
{
    /**
    ...
    public function testCalculatePreviewWithoutDiscountTransportAndPayment(): void
    {
        ...
        $totalPrice = new Price(Money::createFromFloat(14458.68, 2), Money::create(17495));
