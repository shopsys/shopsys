...
class AdministratorDataFixture extends AbstractReferenceFixture
{
    ...
    /**
     * @var \App\Model\Administrator\AdministratorDataFactory
     */
    private AdministratorDataFactory $administratorDataFactory;
     ...
     */
    public function __construct(AdministratorFacade $administratorFacade, AdministratorDataFactory $administratorDataFactory)
    {
