...
and this project adheres to [Semantic Versioning](http://semver.org/spec/v2.0.0.html) as explained [Our Backward Compatibility Promise](/docs/contributing/our-backward-compatibility-promise.md).
