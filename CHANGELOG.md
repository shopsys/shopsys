...
- [#13](https://github.com/shopsys/coding-standards/pull/13/) [EasyCodingStandard](https://github.com/Symplify/EasyCodingStandard) is now used
    - the tool rules config file changed its format from neon to yaml 
##### Removed
