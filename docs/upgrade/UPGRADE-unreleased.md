...
- if you have extended any of following factories, provide `Domain` object to parent constructor ([#787](https://github.com/shopsys/shopsys/pull/787))
    ...
    - `UnitDataFactory`
- (*low priority*) if you want to test flow of coupon code in cart page, implement new acceptance tests ([#825](https://github.com/shopsys/shopsys/pull/825))
    ...
    +        AcceptanceTester $me
    +    ) {
    +        $me->wantTo('see the price of products in cart after coupon is applied');
    +
