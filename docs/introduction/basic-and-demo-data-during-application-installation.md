...
This is the responsibility of `phing` task `domains-data-create` that executes [`CreateDomainsDataCommand`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Command/CreateDomainsDataCommand.php).
