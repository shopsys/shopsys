...
### [GroupType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/GroupType.php)
...
### [DisplayOnlyCustomerType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DisplayOnlyCustomerType.php)
...
### [DisplayOnlyType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DisplayOnlyType.php)
...
### [DisplayOnlyUrlType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DisplayOnlyUrlType.php)

Displays custom URL based on routing system.

### [LocalizedFullWidthType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/LocalizedFullWidthType.php)

Displays localized field in vertical order of full-width label and inputs.

### [OrderItemsType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/OrderItemsType.php)
...
### [LocalizedType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/Locale/LocalizedType.php)
...
### [CategoriesType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/CategoriesType.php)
...
### [CategoryCheckboxType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/CategoryCheckboxType.php)
...
### [ColorPickerType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/ColorPickerType.php)

Displays text field with box of given color that shows color picker when clicked.

### [DatePickerType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DatePickerType.php)
...
### [DateTimeType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DateTimeType.php)
...
### [DisplayOnlyDomainIconType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DisplayOnlyDomainIconType.php)

Displays domain icon with the domains name for given domain ID in `data` option.

### [DomainsType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DomainsType.php)

Displays list of non-required checkboxes for every domain with the domain name as label.

### [DomainType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/DomainType.php)
...
Defines which entity class (defined in [uploaded_files.yaml](https://github.com/shopsys/shopsys/blob/HEAD/project-base/config/uploaded_files.yaml)) should the files be assigned to.

#### file_type

Defines which type of file (defined in [uploaded_files.yaml](https://github.com/shopsys/shopsys/blob/HEAD/project-base/config/uploaded_files.yaml)) should the files be assigned to.
...
### [FriendlyUrlType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/FriendlyUrlType.php)
...
### [OrderListType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/OrderListType.php)
...
### [PriceTableType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/PriceTableType.php)
...
### [ProductCalculatedPricesType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/ProductCalculatedPricesType.php)
...
### [ProductsType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/ProductsType.php)
...
### [ProductType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/ProductType.php)
...
### [SingleCheckboxChoiceType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/SingleCheckboxChoiceType.php)

Displays a list of choices shown as checkboxes.

### [SortableValuesType](https://github.com/shopsys/shopsys/blob/HEAD/packages/framework/src/Form/SortableValuesType.php)
...
### [MultidomainType](https://github.com/shopsys/shopsys/blob/HEAD/packages/form-types-bundle/src/MultidomainType.php)
...
### [YesNoType](https://github.com/shopsys/shopsys/blob/HEAD/packages/form-types-bundle/src/YesNoType.php)
...
### [ActionBarType](https://github.com/shopsys/shopsys/blob/HEAD/packages/form-types-bundle/src/ActionBarType.php)
