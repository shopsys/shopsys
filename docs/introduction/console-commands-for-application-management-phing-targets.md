...
#### clean-redis-old
Cleans up cache in Redis database for old build versions (but keeps sessions).
Old build version is any different from current `build-version` generated by [generate-build-version](#generate-build-version).
