...
[`Money`](https://github.com/shopsys/shopsys/blob/8.0/packages/framework/src/Component/Money/Money.php) is an immutable [value object](https://codete.com/blog/value-objects/).
...
!!! tip
    If in doubt about the results of any method, you can take a look at [its unit tests](https://github.com/shopsys/shopsys/blob/8.0/packages/framework/tests/Unit/Component/Money/MoneyTest.php) which contain many examples of the class' behavior.
...
The form type is configured with a model data transformer that converts the value into a `Money` object automatically ([`NumericToMoneyTransformer`](https://github.com/shopsys/shopsys/blob/8.0/packages/framework/src/Form/Transformers/NumericToMoneyTransformer.php)).
...
[`Price`](https://github.com/shopsys/shopsys/blob/8.0/packages/framework/src/Model/Pricing/Price.php) is also an immutable [value object](https://codete.com/blog/value-objects/) used in pricing.
