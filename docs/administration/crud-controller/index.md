...
The Crud Controller is a powerful tool that allows you to easily design UI for creating, reading, updating, and deleting records in the database. It is a part of the [Administration](../index.md) module.
