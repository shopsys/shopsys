...
{
    $datagrid
        // This column is defined automatically and is used to identify the record. You can override it if you want to display a different identifier or you can hide it with second argument set to false.
        ->addIdentifier('id') 
        ->add('number', [
            'label' => t('Order Nr.'),
        ])
