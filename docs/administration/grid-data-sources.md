...
As a data source, the [Grid Component](./grid.md) requires an implementation of [`DataSourceInterface`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Component/Grid/DataSourceInterface.php).

You can find 4 implementations of the interface in Shopsys Framework.

## [`QueryBuilderDataSource`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Component/Grid/QueryBuilderDataSource.php)
...
## [`QueryBuilderWithRowManipulatorDataSource`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Component/Grid/QueryBuilderWithRowManipulatorDataSource.php)
...
## [`ArrayDataSource`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Component/Grid/ArrayDataSource.php)
...
```
## [`MoneyConvertingDataSourceDecorator`](https://github.com/shopsys/shopsys/blob/7.3/packages/framework/src/Component/Grid/MoneyConvertingDataSourceDecorator.php)
