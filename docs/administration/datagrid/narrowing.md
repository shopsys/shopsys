...
`datagrid_controls` block of the CRUD list template, where it shares one row of the toolbar with the button
opening the filter) and narrows the records by `Condition::orX()` of
