...
This component is built on top of the [Grid](./internal-grid/index.md) component and provides easier configuration. It can be also used as a standalone component outside of the Crud Controller.
