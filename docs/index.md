...
* Thanks to [Our Backward Compatibility Promise](/docs/contributing/our-backward-compatibility-promise.md) it should be clear to which versions you can upgrade safely and how we plan to maintain the code in the future
