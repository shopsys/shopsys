...
provides a signpost of customizations that are easily achievable as well as a list of customizations that are not (and will not be) possible at all.
...
- [Extending an entity](entity-extension.md)
    ...
    - [Removing an attribute from a framework entity](entity-extension.md#how-can-i-remove-property-from-parent-entity)
...
- Configuring the smoke tests (see [`RouteConfigCustomization`]({{github.link}}/project-base/app/tests/App/Smoke/Http/RouteConfigCustomization.php) class)
