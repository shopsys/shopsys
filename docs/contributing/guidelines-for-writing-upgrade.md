...
-   Make instructions as easy to follow as possible
    -   Good example: [postgres upgrade]({{github.link}}/UPGRADE.md#postgresql-upgrade)
...
-   Link files in an accurate version, because the project evolves in time
    ...
    -   Bad example: [installation using docker - master]({{github.link}}/docs/installation/installation-using-docker-application-setup.md)
-   Write instructions
...
The main file where a project developer should start looking for instructions is [`UPGRADE.md`]({{github.link}}/UPGRADE.md) file in the monorepo root.

This file contains information for the contributors in the form of the link to [`upgrade/upgrading-monorepo.md`]({{github.link}}/upgrade/upgrading-monorepo.md) file.
