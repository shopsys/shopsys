...
Examples of such duplication are definitions of [Elasticsearch indexes](https://github.com/shopsys/shopsys/tree/7.3/project-base/src/Shopsys/ShopBundle/Resources/definition/product).
