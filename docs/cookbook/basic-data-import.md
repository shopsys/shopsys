...
### Step 1 - Add `$extId` to [Product]({{github.link}}/project-base/app/src/Model/Product/Product.php) [entity](../model/introduction-to-model-architecture.md#entity)
...
#### 2.2 - Add cron configuration to [`cron.yaml`]({{github.link}}/project-base/app/config/cron.yaml)

```diff
# app/config/cron.yaml
...
Add information about the class extension into the container configuration in [`services.yaml`]({{github.link}}/project-base/app/config/services.yaml).
...
class as a parameter, you can use [`ProductDataFactory`]({{github.link}}/project-base/app/src/Model/Product/ProductDataFactory.php) to create it.
