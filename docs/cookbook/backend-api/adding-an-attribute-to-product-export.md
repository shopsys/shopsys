...
[`ApiProductTransformer`](https://github.com/shopsys/shopsys/blob/8.0/packages/backend-api/src/Controller/V1/Product/ApiProductTransformer.php) is responsible for providing array of product data to backend API controllers.
