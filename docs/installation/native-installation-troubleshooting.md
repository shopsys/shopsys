...
Monolog is configured to log into streams in [`app/config/packages/monolog.yml`](https://github.com/shopsys/shopsys/blob/8.0/project-base/app/config/packages/monolog.yml).
