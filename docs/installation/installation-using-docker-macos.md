...
Create `docker-compose.yml` from template [`docker-compose-mac.yml.dist`](https://github.com/shopsys/shopsys/blob/master/project-base/docker/conf/docker-compose-mac.yml.dist) and `mutagen.yml` from template [`mutagen.yml.dist`]({{github.link}}/project-base/docker/conf/mutagen.yml.dist).
