...
class SeoAttributesQueryDtoFactoryTest extends TestCase
{
    private SeoAttributesQueryDtoFactory $seoAttributesQueryDtoFactory;

    #[Override]
    protected function setUp(): void
    {
        $this->seoAttributesQueryDtoFactory = new SeoAttributesQueryDtoFactory();
    }
    ...
    public function testAllAttributesAreCopiedFromSeoAttributes(): void
    {
        ...
        $result = $this->seoAttributesQueryDtoFactory->createFromSeoAttributes($seoAttributes, '<p>Fallback</p>');
    ...
    {
        $result = $this->seoAttributesQueryDtoFactory->create(
            null,
            '   ',
            null,
            null,
    ...
    public function testFallbackMetaDescriptionIsTruncatedToWholeWords(): void
    {
        ...
        $result = $this->seoAttributesQueryDtoFactory->create(null, null, null, null, null, $longDescription);

        $this->assertLessThanOrEqual(SeoAttributesQueryDtoFactory::META_DESCRIPTION_MAX_LENGTH, mb_strlen($result->metaDescription));
        $this->assertStringEndsWith('word', $result->metaDescription);
    }

    public function testMetaDescriptionIsNullWithoutAnySource(): void
    {
        $result = $this->seoAttributesQueryDtoFactory->create(null, null, null, null, null, '<p> </p>');
