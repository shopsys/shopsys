...
class ProductCanBeOrdered extends Constraint
{
    ...
    public $pricesDoesNotMatchMessage = 'Price for product {{ uuid }} has changed';

    public $noSellingPriceMessage = 'Product {{ uuid }} does not have any selling price';

    public $productNotFoundMessage = 'Product {{ uuid }} no longer available or doesn\'t exist';
