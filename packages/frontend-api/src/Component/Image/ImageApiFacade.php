...
class ImageApiFacade
{
     ...
     * @return int[]
     */
    public function getEntityIdsWithImageByEntityNameAndType(string $entityName, ?string $type): array
    {
        return $this->inMemoryCache->getOrSaveValue(
            static::IMAGE_API_CACHE_NAMESPACE,
            fn () => $this->imageApiRepository->getEntityIdsWithImageByEntityNameAndType($entityName, $type),
