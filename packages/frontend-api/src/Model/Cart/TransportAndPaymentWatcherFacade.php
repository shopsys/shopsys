...
class TransportAndPaymentWatcherFacade
{
    ...
    public function checkTransportAndPayment(
        ...
        $this->cartWithModificationsResult->setTotalProductDiscountPrice($orderData->getTotalProductDiscountsPrice()->inverse());
        $this->cartWithModificationsResult->setTotalDiscountPrice($orderData->getTotalDiscountsPrice()->inverse());
