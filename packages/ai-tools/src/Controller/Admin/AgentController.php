...
use Shopsys\AiToolsBundle\Form\Admin\Agent\AgentFormType;
use Shopsys\AiToolsBundle\Model\Chat\Agent\AgentDataFactory;
use Shopsys\AiToolsBundle\Model\Chat\Agent\AgentFacade;
use Shopsys\AiToolsBundle\Model\Chat\Agent\AgentRepository;
...
class AgentController extends AdminBaseController
{
    ...
    public function newAction(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this
                ->addSuccessFlashTwig(
                    ...
                    [
                        'name' => $agent->getName(),
                        'url' => $this->generateUrl('shopsys_aitools_admin_agent_edit', ['id' => $agent->getId()]),
                    ],
                );

            return $this->redirectToRoute('shopsys_aitools_admin_agent_list');
        }
        ...
        return $this->render('@ShopsysAiTools/Admin/Content/Agent/new.html.twig', [
    ...
    public function editAction(Request $request, int $id): Response
    {
        ...
        return $this->render('@ShopsysAiTools/Admin/Content/Agent/edit.html.twig', [
            'form' => $form->createView(),
            'agent' => $agent,
        ]);
    }
    ...
    public function deleteConfirmAction(int $id): Response
    {
        ...
        if ($this->agentFacade->isAgentUsed($agent)) {
            ...
            return $this->confirmDeleteResponseFactory->createSetNewAndDeleteResponse(
                $message,
                'shopsys_aitools_admin_agent_delete',
                $id,
        ...
        return $this->confirmDeleteResponseFactory->createDeleteResponse($message, 'shopsys_aitools_admin_agent_delete', $id);
    }
    ...
    public function listAction(): Response
    {
        ...
        return $this->render('@ShopsysAiTools/Admin/Content/Agent/list.html.twig', [
    ...
    protected function getGrid(): Grid
    {
        ...
        $grid->addEditActionColumn('shopsys_aitools_admin_agent_edit', ['id' => 'a.id']);
        $grid->addDeleteActionColumn('shopsys_aitools_admin_agent_deleteconfirm', ['id' => 'a.id'])
            ->setAjaxConfirm();

        $grid->setTheme('@ShopsysAiTools/Admin/Content/Agent/listGrid.html.twig');
