...
namespace Shopsys\AiToolsBundle\Form\Admin\VectorStore;

use Override;
use Shopsys\AiToolsBundle\Model\Chat\VectorStore\VectorStore;
use Shopsys\AiToolsBundle\Model\Chat\VectorStore\VectorStoreData;
...
class VectorStoreFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('actionBar', ActionBarType::class, [
            'back_route' => 'shopsys_aitools_admin_vectorstore_list',
