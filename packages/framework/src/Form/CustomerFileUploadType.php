...
use Shopsys\FrameworkBundle\Component\CustomerUploadedFile\CustomerUploadedFileData;
use Shopsys\FrameworkBundle\Component\CustomerUploadedFile\CustomerUploadedFileFacade;
use Shopsys\FrameworkBundle\Component\UploadedFile\Config\UploadedFileTypeConfig;
use Shopsys\FrameworkBundle\Form\Transformers\CustomerFilesIdsToFilesTransformer;
...
class CustomerFileUploadType extends AbstractType
{
    /**
     * @param \Shopsys\FrameworkBundle\Component\CustomerUploadedFile\CustomerUploadedFileFacade $uploadedFileFacade
     * @param \Shopsys\FrameworkBundle\Form\Transformers\CustomerFilesIdsToFilesTransformer $filesIdsToFilesTransformer
     */
    public function __construct(
        private readonly CustomerUploadedFileFacade $uploadedFileFacade,
        private readonly CustomerFilesIdsToFilesTransformer $filesIdsToFilesTransformer,
    ) {
    }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver
            ...
            ->setDefault('data_class', CustomerUploadedFileData::class)
