...
final class OrderAddressesFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        // Company fields (companyName, companyNumber, companyTaxNumber) were moved from OrderPersonalFormType
        // to this form because they belong to billing details, not personal data.
        // Order::fillCommonFields() persists company info only when isCompanyCustomer is true,
        // so we infer the flag from the presence of companyName here. Without this listener
        // the company data would be wiped on every save through this form.
