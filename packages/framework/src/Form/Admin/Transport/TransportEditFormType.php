...
class TransportEditFormType extends AbstractType
{
    ...
    public function __construct(CurrencyFacade $currencyFacade, TransportPriceCalculation $transportPriceCalculation)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builderPricesGroup
            ->add('pricesByCurrencyId', PriceTableType::class, [
                ...
                'base_prices' => $transport !== null ? $transport->getBasePricesIndexedByCurrencyId($this->transportPriceCalculation) : [],
            ]);
