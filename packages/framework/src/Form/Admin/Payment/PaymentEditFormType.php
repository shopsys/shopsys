...
class PaymentEditFormType extends AbstractType
{
    ...
    public function __construct(CurrencyFacade $currencyFacade, PaymentPriceCalculation $paymentPriceCalculation)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builderPriceGroup
            ->add('pricesByCurrencyId', PriceTableType::class, [
                ...
                'base_prices' => $payment !== null ? $payment->getBasePricesIndexedByCurrencyId($this->paymentPriceCalculation) : [],
            ]);
