...
class ReadyCategorySeoMixFacade
{
    ...
    protected function saveReadyCategoryMixFriendlyUrls(
        ...
        $this->friendlyUrlFacade->saveUrlListFormData('front_category_seo', $readyCategorySeoMix->getId(), $domainId, $urlListData);
        ...
        $this->friendlyUrlFacade->saveUrlListFormData('front_category_seo', $readyCategorySeoMix->getId(), $domainId, $urlListDataForMainFriendlyUrl);
    }
    ...
    protected function getParameterValueIdsByParameterId(array $parametersFilterData, string $currentLocale): array
    {
        ...
        foreach ($parametersFilterData as $parameterFilterData) {
            ...
            if (count($parameterFilterData['values']) === 0) {
                ...
                $parameterValueId = $this->parameterFacade->getParameterValueByValueTextAndLocale((string)$text, $currentLocale);
            } else {
