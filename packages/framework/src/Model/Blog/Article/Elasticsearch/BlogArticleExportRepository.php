...
class BlogArticleExportRepository
{
    ...
    public function extractBlogArticle(BlogArticle $blogArticle, int $domainId, string $locale): array
    {
        ...
        return [
            ...
            'seoTitle' => $blogArticle->getSeoAttributes($domainId)->getTitle(),
            'seoMetaDescription' => $blogArticle->getSeoAttributes($domainId)->getMetaDescription(),
            'seoH1' => $blogArticle->getSeoAttributes($domainId)->getH1(),
