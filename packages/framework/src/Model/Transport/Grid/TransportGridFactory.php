...
class TransportGridFactory implements GridFactoryInterface
{
    ...
    public function create()
    {
        ...
        $grid->addColumn('displayPrice', 'displayPrice', t('Price'));
    ...
    {
        $transportBasePricesIndexedByCurrencyId = $transport->getBasePricesIndexedByCurrencyId($this->transportPriceCalculation);
