...
class ComplaintAdvancedSearchFilterTranslation extends AdvancedSearchFilterTranslation
{
    public function __construct()
    {
        ...
        $this->addFilterTranslation(Filter\ComplaintOrderNumberFilter::NAME, t('Order number'));
