...
{
    /**
     * @var \Shopsys\FrameworkBundle\Model\Chat\Agent\FunctionCalling\FunctionRunnerSetup[]
     */
    ...
    public function __construct(
        ...
        foreach ($this->aiFunctionList as $aiFunction) {
            /** @var \Shopsys\FrameworkBundle\Model\Chat\Agent\FunctionCalling\FunctionRunnerSetup $functionRunnerSetup */
     ...
     * @return \Shopsys\FrameworkBundle\Model\Chat\Agent\FunctionCalling\FunctionRunnerSetup|null
     */
