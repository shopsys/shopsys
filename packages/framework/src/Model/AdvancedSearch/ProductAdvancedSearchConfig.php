...
use Shopsys\FrameworkBundle\Model\AdvancedSearch\Filter\ProductHasPromotionFilter;
...
class ProductAdvancedSearchConfig extends AdvancedSearchConfig
{
     ...
     * @param \Shopsys\FrameworkBundle\Model\AdvancedSearch\Filter\ProductHasPromotionFilter $productHasPromotionFilter
     */
    public function __construct(
        ...
        ProductHasPromotionFilter $productHasPromotionFilter,
    ) {
        parent::__construct();
