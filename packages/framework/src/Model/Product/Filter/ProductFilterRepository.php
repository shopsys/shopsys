...
class ProductFilterRepository
{
     ...
     */
    protected function filterByFlags(QueryBuilder $productsQueryBuilder, array $flags): void
    {
     ...
     */
    protected function filterByBrands(QueryBuilder $productsQueryBuilder, array $brands): void
    {
