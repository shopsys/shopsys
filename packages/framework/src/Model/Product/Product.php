...
class Product extends AbstractTranslatableEntity
{
     ...
     */
    public static function create(ProductData $productData): static
    {
     ...
     * @return \Shopsys\FrameworkBundle\Model\Product\Product
     */
    public static function createMainVariant(ProductData $productData, array $variants): static
    {
     ...
     * @return string|null
     */
    public function getVariantAlias($locale = null): ?string
    {
     ...
     */
    protected function getProductCategoryDomainsByDomainIdIndexedByCategoryId($domainId): array
    {
     ...
     */
    protected function setRecalculateVisibility($recalculateVisibility): void
    {
     ...
     * @param int $quantity
     */
    public function addStockQuantity($quantity): void
    {
     ...
     * @param int $quantity
     */
    public function subtractStockQuantity($quantity): void
    {
        $this->stockQuantity -= $quantity;
    }
     ...
     * @return bool
     */
    public function isMarkedForVisibilityRecalculation(): bool
    {
     ...
     * @param \Shopsys\FrameworkBundle\Model\Product\Product[] $currentVariants
     */
    protected function unsetRemovedVariants(array $currentVariants): void
    {
