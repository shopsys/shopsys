...
class PluginCrudExtensionRegistry
{
     ...
     */
    public function registerCrudExtension(PluginCrudExtensionInterface $crudExtension, $type, $serviceId): void
    {
     ...
     * @param string $type
     */
    public static function assertTypeIsKnown($type): void
    {
