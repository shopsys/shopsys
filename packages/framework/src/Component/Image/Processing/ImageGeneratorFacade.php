...
class ImageGeneratorFacade
{
     ...
     * @return string
     */
    public function generateImageAndGetFilepath(string $entityName, $imageId, ?string $type, ?string $sizeName): string
    {
     ...
     * @return string
     */
    public function generateAdditionalImageAndGetFilepath(
        string $entityName,
        int $imageId,
        int $additionalIndex,
        ?string $type,
