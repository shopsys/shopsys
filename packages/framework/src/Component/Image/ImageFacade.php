...
class ImageFacade
{
     ...
     * @param string|null $type
     */
    protected function uploadImage(object $entity, array $temporaryFilenames, ?string $type): void
    {
     ...
     * @param string|null $type
     */
    protected function uploadImages(object $entity, ?array $temporaryFilenames, ?string $type): void
    {
