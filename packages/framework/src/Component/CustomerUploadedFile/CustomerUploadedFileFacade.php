...
class CustomerUploadedFileFacade extends AbstractUploadedFileFacade
{
     ...
     * @param \Shopsys\FrameworkBundle\Component\CustomerUploadedFile\CustomerUploadedFileFactoryInterface $customerUploadedFileFactory
     */
    public function __construct(
        ...
        protected readonly CustomerUploadedFileFactoryInterface $customerUploadedFileFactory,
    ) {
