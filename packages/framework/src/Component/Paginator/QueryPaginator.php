...
class QueryPaginator implements PaginatorInterface
{
     ...
     */
    public function __construct(protected readonly QueryBuilder $queryBuilder, ?string $hydrationMode = null)
    {
     ...
     */
    protected function getTotalNativeQuery(QueryBuilder $queryBuilder): \Doctrine\ORM\NativeQuery
    {
