 ...
 * around every handler call (symfony/symfony#52425). After the upgrade, replace this class and its decoration
 * in services.yaml with an event subscriber calling the same DelayedEnvelopesCollector methods.
 */
