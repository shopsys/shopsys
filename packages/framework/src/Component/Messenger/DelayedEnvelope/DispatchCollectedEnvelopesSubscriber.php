...
class DispatchCollectedEnvelopesSubscriber implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            // priority must be higher than ResetWorkerOnClosedEntityManagerSubscriber, which may throw StopWorkerException
            WorkerMessageFailedEvent::class => ['handleConfirmedMessageEnvelopes', 20],
        ];
    }
}
