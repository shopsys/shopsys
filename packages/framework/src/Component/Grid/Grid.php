...
class Grid
{
    ...
    {
        /** @var array $queryData */
        $queryData = $this->requestStack->getMainRequest()->query->get(self::GET_PARAMETER, null) ?? [];
        ...
        $requestData = $this->requestStack->getMainRequest()->request->get(self::GET_PARAMETER, null) ?? [];
