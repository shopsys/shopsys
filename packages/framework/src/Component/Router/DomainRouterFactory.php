...
class DomainRouterFactory
{
     ...
     */
    protected function getBasicRouter(DomainConfig $domainConfig): \Symfony\Bundle\FrameworkBundle\Routing\Router
    {
        return new Router(
            $this->container,
     ...
     */
    protected function getRequestContextByDomainConfig(DomainConfig $domainConfig): \Symfony\Component\Routing\RequestContext
    {
