...
final class Version20260720192055 extends AbstractMigration
{
    ...
    {
        $this->sql('ALTER TABLE transports ADD delivers_on_weekends BOOLEAN NOT NULL DEFAULT FALSE');
        ...
        $this->sql('ALTER TABLE transports ALTER COLUMN delivers_on_weekends DROP DEFAULT');
