...
class Version20180603135342 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        if ($defaultCurrencyId <= 0) {
            $this->sql('INSERT INTO setting_values (name, domain_id, value, type) VALUES (\'defaultCurrencyId\', 0, 2, \'integer\')');
        }
        ...
        if ($defaultDomainCurrencyId <= 0) {
            $this->sql('INSERT INTO setting_values (name, domain_id, value, type) VALUES (\'defaultDomainCurrencyId\', 1, 2, \'integer\')');
        }
    }
