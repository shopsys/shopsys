...
class Version20250502180152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->sql('INSERT INTO chat_agents (name, enabled, model, setup, internal_key, available_ai_functions) VALUES (:name, :enabled, :model, :setup, :internalKey, :availableFunctions)', [
