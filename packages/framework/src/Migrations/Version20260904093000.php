    ...
    public function up(Schema $schema): void
    {
        ...
        $this->sql(
            'INSERT INTO transports (hidden, deleted, position, uuid, days_until_delivery, type, delivery_days_of_week, delivers_on_public_holidays, delivers_on_internal_closed_days)
                VALUES (FALSE, FALSE, (SELECT COALESCE(MAX(position), -1) + 1 FROM transports t), uuid_generate_v4(), 0, :type, :deliveryDaysOfWeek, TRUE, TRUE)',
            ['type' => TransportTypeEnum::TYPE_EMAIL, 'deliveryDaysOfWeek' => '[1, 2, 3, 4, 5, 6, 7]'],
        );
