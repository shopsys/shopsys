...
class AnnotationsAdderTest extends TestCase
{
    ...
    public static function extractPropertyOrMethodAnnotationNameDataProvider(): array
    {
        return [
            ...
            ['property-test', '@property array<int, array<string, string[]>> $test'],
            ['property-test', '@property \Doctrine\Common\Collections\Collection<int, \App\Model\Cart\Item\CartItem> $test'],
            ...
            ['method-test', '@method array<int, array<string, string[]>> test()'],
            ['method-test', '@method array<int, \App\Model\Category\Category> test(int[] $ids)'],
