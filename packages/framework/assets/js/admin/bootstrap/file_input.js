...
(function ($) {
    ...
    $.fn.bootstrapFileInput = function () {
        ...
        this.each(function (i, elem) {
            ...
            $elem.wrap('<a class="js-fileInputWrapper btn ' + className + '"></a>').parent().prepend($('<span></span>').html(buttonWord)).prepend($('<span class="icon-wrapper">' + IconFolder + '</span>'));
        })
        ...
        // This is important because the in order to give the illusion that this is a button in FF we actually need to move the button from the file input under the cursor. Ugh.
            .promise().done(function () {
                ...
                $('.js-fileInputWrapper').mousemove(function (cursor) {
                    ...
                    const moveInputX = cursorX - wrapperX - inputWidth + 20;
                    // Slides the invisible input Browse button to be positioned middle under the cursor
                    const moveInputY = cursorY - wrapperY - (inputHeight / 2);
