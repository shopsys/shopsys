...
final class CrudConfigTemplateTest extends TestCase
{
    ...
    public function testTemplateSetLaterReplacesEarlierOne(): void
    {
        // extensions are configured after the controller, so their template replaces the one the controller set
        $crudConfig = new CrudConfig('Product review');
