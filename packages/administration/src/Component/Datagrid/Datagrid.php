...
final class Datagrid
{
    ...
    private DatagridRowActions $rowActions;
    ...
    public function __construct(
        ...
        $this->rowActions = new DatagridRowActions();
     ...
     */
    public function rowActions(): DatagridRowActions
    {
    ...
    public function createView(): GridView
    {
        ...
        foreach ($this->rowActions()->getRowActions() as $action) {
