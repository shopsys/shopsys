...
final class OrmAdapter implements AdapterInterface
{
     ...
     * @param array<string, \Shopsys\AdministrationBundle\Component\Datagrid\Field\FieldDescriptor> $fields
    ...
    private function createProxyQuery(string $entityClass): ProxyQuery
    {
        ...
        return new ProxyQuery($entityClass, $entityManager, $this->localization->getAdminLocale());
    }
}
