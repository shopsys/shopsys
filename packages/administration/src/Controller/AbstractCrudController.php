...
abstract class AbstractCrudController extends AdminBaseController
{
    ...
    /**
     * Shapes the query of the list statically — a fixed scope, a default join, an ordering. It runs once when
     * the adapter is created, without any request, so a condition driven by the administrator never belongs
     * here: it goes through the conditions of the datagrid, which keep it parameterized and medium-agnostic.
     */
    ...
    public function listAction(): Response
    {
        ...
        return $this->render('@ShopsysAdministration/crud/list.html.twig', [
            ...
            'filterForm' => $datagrid->getFilterForm(),
        ]);
    }
