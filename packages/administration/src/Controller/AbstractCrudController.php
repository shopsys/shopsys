...
abstract class AbstractCrudController extends AdminBaseController
{
    ...
    /**
     * The edit page shows the change history when it is not hidden by the config and the entity has entity logging enabled
     */
    protected function isEntityLogShown(): bool
    {
        return $this->definition->getConfig()->isEntityLogShown()
            && $this->loggableEntityConfigFactory->getLoggableSetupByEntity($this->definition->entityClass)->isLoggable();
    }
