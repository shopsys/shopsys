...
final class NoUselessAccessFixerTest extends AbstractCheckerTestCase
{
    public function testFix(): void
    {
        ...
        $this->doTestWrongToFixedFile(
            __DIR__ . '/wrong/DifferentAnnotationAndVisibility.php',
            __DIR__ . '/fixed/DifferentAnnotationAndVisibility.php'
        );
        $this->doTestWrongToFixedFile(
            __DIR__ . '/wrong/EmptyAccessAnnotation.php',
            __DIR__ . '/fixed/EmptyAccessAnnotation.php'
        );
    }
