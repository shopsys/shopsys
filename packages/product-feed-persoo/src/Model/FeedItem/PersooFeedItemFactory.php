...
class PersooFeedItemFactory
{
     ...
     * @return \Shopsys\ProductFeed\PersooBundle\Model\FeedItem\PersooFeedItem
     */
    public function create(Product $product, DomainConfig $domainConfig): PersooFeedItem
    {
