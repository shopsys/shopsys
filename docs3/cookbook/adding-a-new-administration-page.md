...
To see how the side menu works, you can see the [`SideMenuBuilder`]({{github.link}}/packages/framework/src/Model/AdminNavigation/SideMenuBuilder.php) class where it is created.
