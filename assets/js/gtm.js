...
const LOCALSTORAGE_FILTER_TAG = 'filter';
const FILTER_FIRST_SECTION_LABEL = 'Dostupnost a akce';
const FILTER_ON_TEXT = 'Filtrace on';
const FILTER_OFF_TEXT = 'Filtrace off';
