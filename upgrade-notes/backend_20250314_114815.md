...
- new parameter `shopsys.mail_template.display_price` that accepts `input_type` (default) or `both` values to set displayed values in mail templates for transport, payment and product price
