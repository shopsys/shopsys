...
- `Order::isPaid` and `Order::hasPaymentInProcess` methods has been moved to `OrderFacade`
- `PaymentTransaction::isGatewayPayment` method has been mvoed to `OrderFacade`
