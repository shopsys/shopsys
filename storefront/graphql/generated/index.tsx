...
export type ProductFilterOptionsFragmentApi = { __typename?: 'ProductFilterOptions', minimalPrice: string, maximalPrice: string, inStock: number, brands: Array<{ __typename?: 'BrandFilterOption', count: number, brand: { __typename?: 'Brand', uuid: string, name: string } }> | null, flags: Array<{ __typename?: 'FlagFilterOption', count: number, flag: { __typename?: 'Flag', uuid: string, name: string, rgbColor: string } }> | null, parameters: Array<{ __typename: 'ParameterCheckboxFilterOption', name: string, uuid: string, values: Array<{ __typename?: 'ParameterValueFilterOption', uuid: string, text: string, count: number }> } | { __typename: 'ParameterColorFilterOption', name: string, uuid: string, values: Array<{ __typename?: 'ParameterValueColorFilterOption', uuid: string, text: string, count: number, rgbHex: string | null }> } | { __typename: 'ParameterSliderFilterOption', name: string, uuid: string, minimalValue: number, maximalValue: number, unit: { __typename?: 'Unit', name: string } | null }> | null };

export type ProductFilterOptionsParametersCheckboxFragmentApi = { __typename: 'ParameterCheckboxFilterOption', name: string, uuid: string, values: Array<{ __typename?: 'ParameterValueFilterOption', uuid: string, text: string, count: number }> };

export type ProductFilterOptionsParametersColorFragmentApi = { __typename: 'ParameterColorFilterOption', name: string, uuid: string, values: Array<{ __typename?: 'ParameterValueColorFilterOption', uuid: string, text: string, count: number, rgbHex: string | null }> };

export type ProductFilterOptionsParametersSliderFragmentApi = { __typename: 'ParameterSliderFilterOption', name: string, uuid: string, minimalValue: number, maximalValue: number, unit: { __typename?: 'Unit', name: string } | null };
