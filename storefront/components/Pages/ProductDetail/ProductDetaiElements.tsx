...
export const ProductDetailPrefix: FC<PropsWithDataTestId> = ({ children, dataTestId }) => (
    <div className="mb-1 text-greyLight" data-testid={dataTestId}>
        {children}
    </div>
);

export const ProductDetailHeading: FC<PropsWithDataTestId> = ({ children, dataTestId }) => (
    <h1 className="mb-2 text-2xl font-bold text-black" data-testid={dataTestId}>
        {children}
    </h1>
);

export const ProductDetailCode: FC<PropsWithDataTestId> = ({ children, dataTestId }) => (
