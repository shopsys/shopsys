            ...
            <label
                ...
                className={twMergeCustom(
                    ...
                    inputType === 'checkbox' && [
                        ...
                        'peer-checked:before:!bg-bottom peer-hover:before:bg-top peer-focus:before:bg-top peer-active:before:bg-top peer-disabled:pointer-events-none peer-disabled:cursor-no-drop peer-disabled:text-greyLight peer-disabled:opacity-50 peer-disabled:before:cursor-no-drop peer-disabled:before:bg-right',
