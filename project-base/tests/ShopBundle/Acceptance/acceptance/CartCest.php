...
class CartCest
{
    ...
    public function testAddToCartFromProductListPage(
        ...
        $me->amOnPage('/cart/');
        $cartPage->assertProductPrice('Defender 2.0 SPK-480', '€5.00');
    }
    ...
    public function testAddToCartFromHomepage(
        ...
        $cartBoxPage->seeInCartBox('1 item');
        $me->amOnPage('/cart/');
        $cartPage->assertProductPrice('22" Sencor SLE 22F46DM4 HELLO KITTY', '€140.00');
    }
    ...
    public function testPricingInCart(
        ...
        $me->amOnPage('/cart/');
        $cartPage->assertTotalPriceWithVat('€745.00');
    }
    ...
    public function testPromoCodeFlowInCart(
        ...
        $cartPage->assertTotalPriceWithVat('€6.00');

        $cartPage->removePromoCode();

        $cartPage->canSeePromoCodeSubmitButtonElement();
        $cartPage->assertTotalPriceWithVat('€7.00');
    }
}
