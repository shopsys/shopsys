...
class NewsletterRepository
{
     ...
     * @return bool
     */
    public function existsSubscribedEmailByDomainId($email, $domainId)
    {
     ...
     */
    public function getAllEmailsDataIteratorByDomain($domainId)
    {
     ...
     */
    public function getNewsletterSubscribeByEmailAndDomain($email, $domainId)
    {
