...
class VatDataFixture extends AbstractReferenceFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference(sprintf('%s_%s', self::VAT_ZERO, Domain::FIRST_DOMAIN_ID), $vatZeroRate);
    ...
    protected function createVat(VatData $vatData, int $domainId, $referenceName = null)
    {
        ...
        if ($referenceName !== null) {
            $this->addReference(sprintf('%s_%s', $referenceName, $domainId), $vat);
        }
    }
    ...
    {
        $defaultVat = $this->getReference(sprintf('%s_%s', self::VAT_HIGH, $domainId));
