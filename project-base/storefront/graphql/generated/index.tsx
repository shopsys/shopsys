...
export type BlogArticleDetailFragmentApi = { __typename: 'BlogArticle', id: number, uuid: string, name: string, slug: string, link: string, text: Maybe<string>, publishDate: any, seoTitle: Maybe<string>, seoMetaDescription: Maybe<string>, seoH1: Maybe<string>, breadcrumb: Array<{ __typename: 'Link', name: string, slug: string }>, mainImage: Maybe<{ __typename: 'Image', name: Maybe<string>, sizes: Array<{ __typename: 'ImageSize', size: string, url: string, width: Maybe<number>, height: Maybe<number>, additionalSizes: Array<{ __typename: 'AdditionalSize', height: Maybe<number>, media: string, url: string, width: Maybe<number> }> }> }> };
