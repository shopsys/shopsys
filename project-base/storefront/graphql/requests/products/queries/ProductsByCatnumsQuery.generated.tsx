...
export function useProductsByCatnums(options: Omit<Urql.UseQueryArgs<ProductsByCatnumsVariables>, 'query'>) {
  return Urql.useQuery<ProductsByCatnums, ProductsByCatnumsVariables>({ query: ProductsByCatnumsDocument, ...options });
};