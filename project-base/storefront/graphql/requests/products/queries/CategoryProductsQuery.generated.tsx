...
export type CategoryProductsQueryVariables = Types.Exact<{
...
export function useCategoryProductsQuery(options: Omit<Urql.UseQueryArgs<CategoryProductsQueryVariables>, 'query'>) {
  return Urql.useQuery<CategoryProductsQuery, CategoryProductsQueryVariables>({ query: CategoryProductsQueryDocument, ...options });
};