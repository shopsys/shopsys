...
export function usePromotedProductsQuery(options?: Omit<Urql.UseQueryArgs<PromotedProductsQueryVariables>, 'query'>) {
  return Urql.useQuery<PromotedProductsQuery, PromotedProductsQueryVariables>({ query: PromotedProductsQueryDocument, ...options });
};