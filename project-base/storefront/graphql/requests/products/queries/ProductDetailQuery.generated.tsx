...
export function useProductDetailQuery(options?: Omit<Urql.UseQueryArgs<ProductDetailQueryVariables>, 'query'>) {
  return Urql.useQuery<ProductDetailQuery, ProductDetailQueryVariables>({ query: ProductDetailQueryDocument, ...options });
};