...
export type BrandProductsQueryVariables = Types.Exact<{
...
export function useBrandProductsQuery(options: Omit<Urql.UseQueryArgs<BrandProductsQueryVariables>, 'query'>) {
  return Urql.useQuery<BrandProductsQuery, BrandProductsQueryVariables>({ query: BrandProductsQueryDocument, ...options });
};