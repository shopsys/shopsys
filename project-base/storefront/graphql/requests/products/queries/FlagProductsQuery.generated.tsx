...
export type FlagProductsQueryVariables = Types.Exact<{
...
export function useFlagProductsQuery(options: Omit<Urql.UseQueryArgs<FlagProductsQueryVariables>, 'query'>) {
  return Urql.useQuery<FlagProductsQuery, FlagProductsQueryVariables>({ query: FlagProductsQueryDocument, ...options });
};