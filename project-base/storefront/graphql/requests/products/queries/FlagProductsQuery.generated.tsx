...
export type TypeFlagProductsQueryVariables = Exact<{
  endCursor: string;
...
export type TypeFlagProductsQuery = { products: { __typename: 'ProductConnection', edges: Array<{ __typename: 'ProductEdge', node:
