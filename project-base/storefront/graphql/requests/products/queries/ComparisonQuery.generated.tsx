...
export type ComparisonQueryVariablesApi = Types.Exact<{
    comparisonUuid: Types.InputMaybe<Types.Scalars['Uuid']['input']>;
}>;

export type ComparisonQueryApi = {
    __typename?: 'Query';
    comparison: {
...
export function useComparisonQueryApi(options?: Omit<Urql.UseQueryArgs<ComparisonQueryVariablesApi>, 'query'>) {
    return Urql.useQuery<ComparisonQueryApi, ComparisonQueryVariablesApi>({
        query: ComparisonQueryDocumentApi,
        ...options,
    });
}
