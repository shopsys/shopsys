...
export function useSearchProductsQuery(options: Omit<Urql.UseQueryArgs<SearchProductsQueryVariables>, 'query'>) {
  return Urql.useQuery<SearchProductsQuery, SearchProductsQueryVariables>({ query: SearchProductsQueryDocument, ...options });
};