...
export type TypeProductDetailFragment = { __typename: 'RegularProduct', shortDescription: string | null, usps: Array<string>, availableStoresCount: number | null, isPersonalPickupOnly: boolean, id: number, uuid: string, slug: string, fullName: string, name: string, namePrefix: string | null, nameSuffix: string | null, catalogNumber: string, ean: string | null, description: string | null, zboziCategory: string | null, promotionBuyQuantity: number | null, promotionFreeQuantity: number | null, isSellingDenied: boolean, isCurrentlyOutOfStock: boolean, expectedRestockingDate: string | null, stockQuantity: number | null, isAllowedNegativeStock: boolean, seoTitle: string | null, seoMetaDescription: string | null, isMainVariant: boolean, isInquiryType: boolean, productType: Types.TypeProductTypeEnum, additionalServices: Array<{ __typename: 'AdditionalService', id: number, uuid: string, name: string, catnum: string, description: string | null, deliveryDaysExtension: number | null, price: { __typename: 'Price', priceWithVat: string, priceWithoutVat: string, vatAmount: string }, mainImage: { __typename: 'Image', name: string | null, url: string } | null }>, breadcrumb: Array<{ __typename: 'Link', name: string, slug: string }>, unit: { name: string }, images: Array<{ __typename: 'Image', name: string | null, url: string }>, price: { __typename: 'ProductPrice', priceWithVat: string, priceWithoutVat: string, vatAmount: string, isPriceFrom: boolean, nextPriceChange: string | null, percentageDiscount: number | null, basicPrice: { priceWithVat: string, priceWithoutVat: string, vatAmount: string } }, parameters: Array<{ __typename: 'Parameter', uuid: string, name: string, type: Types.TypeParameterTypeEnum, group: string | null, unit: { __typename: 'Unit', name: string } | null, values: Array<{ __typename: 'ParameterValue', uuid: string, text: string, rgbHex: string | null, colorIcon: { url: string, anchorText: string } | null }> }>, accessories: Array<
