...
export type RemoveProductFromWishlistMutationVariablesApi = Types.Exact<{
...
export const RemoveProductFromWishlistMutationDocumentApi = gql`
    mutation RemoveProductFromWishlistMutation($productUuid: Uuid!, $wishlistUuid: Uuid) {
        removeProductFromWishlist(productUuid: $productUuid, wishlistUuid: $wishlistUuid) {
            ...WishlistFragment
        }
    }
    ${WishlistFragmentApi}
...
export function useRemoveProductFromWishlistMutationApi() {
    return Urql.useMutation<RemoveProductFromWishlistMutationApi, RemoveProductFromWishlistMutationVariablesApi>(
        RemoveProductFromWishlistMutationDocumentApi,
    );
}
