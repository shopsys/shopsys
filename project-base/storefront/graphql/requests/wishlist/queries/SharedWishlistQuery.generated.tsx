...
export type SharedWishlistQueryVariablesApi = Types.Exact<{
    catnums: Array<Types.Scalars['String']['input']> | Types.Scalars['String']['input'];
}>;

export type SharedWishlistQueryApi = {
    __typename?: 'Query';
...
export function useSharedWishlistQueryApi(options: Omit<Urql.UseQueryArgs<SharedWishlistQueryVariablesApi>, 'query'>) {
    return Urql.useQuery<SharedWishlistQueryApi, SharedWishlistQueryVariablesApi>({
        query: SharedWishlistQueryDocumentApi,
        ...options,
    });
}
