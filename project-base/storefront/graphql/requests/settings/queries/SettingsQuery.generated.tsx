...
export type TypeSettingsQuery = { settings: { contactFormMainText: string | null, emailTransportDescription: string | null, displayTimezone: string, heurekaEnabled: boolean, productReviewsEnabled: boolean, privacyPolicyArticleUrl: string | null, productReviewPolicyArticleUrl: string | null, productReviewMinimalAverageRatingForListing: number | null, termsAndConditionsArticleUrl: string | null, userConsentPolicyArticleUrl: string | null, socialNetworkLoginConfig: Array<Types.TypeLoginTypeEnum>, cspHeader: string, defaultPricingGroupId: number, pricing: { __typename: 'PricingSetting', defaultCurrencyCode: string, minimumFractionDigits: number }, seo: { __typename: 'SeoSetting', title: string | null, titleAddOn: string | null, metaDescription: string | null, organization: { name: string | null, vatId: string | null, companyNumber: string | null, description: string | null, streetAddress: string | null, addressLocality: string | null, postalCode: string | null, addressCountry: string | null, logo: string | null, sameAs: Array<string> } }, mainBlogCategoryData: { mainBlogCategoryName: string | null, mainBlogCategoryUrl: string | null, mainBlogCategoryMainImage: { url: string } | null } } | null };
...
export const SettingsQueryDocument = gql`
  ...
  settings {
    ...
    productReviewMinimalAverageRatingForListing
