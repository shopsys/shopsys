...
import { MainBlogCategorySettingFragment } from '../fragments/MainBlogCategorySettingFragment.generated';
...
export type TypeSettingsQuery = {
    ...
    settings: {
        ...
        privacyPolicyArticleUrl: string | null;
        termsAndConditionsArticleUrl: string | null;
        userConsentPolicyArticleUrl: string | null;
        socialNetworkLoginConfig: Array<Types.TypeLoginTypeEnum>;
        ...
        mainBlogCategoryData: {
            ...
            mainBlogCategoryUrl: string | null;
            mainBlogCategoryMainImage: { __typename: 'Image'; name: string | null; url: string } | null;
        };
    } | null;
};
