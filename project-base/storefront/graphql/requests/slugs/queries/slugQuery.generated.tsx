...
export type TypeSlugQueryVariables = Types.Exact<{
...
export function useSlugQuery(options: Omit<Urql.UseQueryArgs<TypeSlugQueryVariables>, 'query'>) {
  return Urql.useQuery<TypeSlugQuery, TypeSlugQueryVariables>({ query: SlugQueryDocument, ...options });
};