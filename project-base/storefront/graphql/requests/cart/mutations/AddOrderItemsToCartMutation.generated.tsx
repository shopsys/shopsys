...
export function useAddOrderItemsToCartMutation() {
  return Urql.useMutation<AddOrderItemsToCartMutation, AddOrderItemsToCartMutationVariables>(AddOrderItemsToCartMutationDocument);
};