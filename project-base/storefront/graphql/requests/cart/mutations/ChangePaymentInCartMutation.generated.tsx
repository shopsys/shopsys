...
export function useChangePaymentInCartMutation() {
  return Urql.useMutation<ChangePaymentInCartMutation, ChangePaymentInCartMutationVariables>(ChangePaymentInCartMutationDocument);
};