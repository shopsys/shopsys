...
import { CartItemFragmentApi } from '../fragments/CartItemFragment.generated';
import * as Urql from 'urql';
export type Omit<T, K extends keyof T> = Pick<T, Exclude<keyof T, K>>;
export type AddToCartMutationVariablesApi = Types.Exact<{
    input: Types.AddToCartInputApi;
}>;
