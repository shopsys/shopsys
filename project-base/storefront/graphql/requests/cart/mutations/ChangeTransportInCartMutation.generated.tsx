...
export function useChangeTransportInCartMutation() {
  return Urql.useMutation<ChangeTransportInCartMutation, ChangeTransportInCartMutationVariables>(ChangeTransportInCartMutationDocument);
};