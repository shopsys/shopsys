...
export function useRemovePromoCodeFromCartMutation() {
  return Urql.useMutation<RemovePromoCodeFromCartMutation, RemovePromoCodeFromCartMutationVariables>(RemovePromoCodeFromCartMutationDocument);
};