...
export function useApplyPromoCodeToCartMutation() {
  return Urql.useMutation<ApplyPromoCodeToCartMutation, ApplyPromoCodeToCartMutationVariables>(ApplyPromoCodeToCartMutationDocument);
};