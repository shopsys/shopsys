...
export function usePersonalDataDetailQuery(options: Omit<Urql.UseQueryArgs<PersonalDataDetailQueryVariables>, 'query'>) {
  return Urql.useQuery<PersonalDataDetailQuery, PersonalDataDetailQueryVariables>({ query: PersonalDataDetailQueryDocument, ...options });
};