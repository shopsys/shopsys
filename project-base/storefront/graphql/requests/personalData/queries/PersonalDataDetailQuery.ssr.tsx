    ...
    accessPersonalData: {
        ...
        orders: Array<{
            ...
            transport: {
                ...
                name: string;
                description: string | null;
                transportTypeCode: Types.TypeTransportTypeEnum;
            };
            productItems: Array<{
                ...
                quantity: number;
                unit: string | null;
                type: Types.TypeOrderItemTypeEnum;
                ...
                order: {
                    ...
                    creationDate: any;
                    customerUser:
                        | { __typename?: 'CompanyCustomerUser'; uuid: string }
                        | { __typename?: 'CurrentCompanyCustomerUser'; uuid: string }
                        | { __typename?: 'CurrentRegularCustomerUser'; uuid: string }
                        | { __typename?: 'RegularCustomerUser'; uuid: string }
                        | null;
                };
                product:
                    | {
                          ...
                          availability: {
                              ...
                              name: string;
                              status: Types.TypeAvailabilityStatusEnum;
                          };
                      }
                    | {
        ...
        customerUser:
            | {
                  ...
                  roles: Array<Types.TypeCustomerUserRoleEnum>;
                  ...
                  roleGroup: { __typename: 'CustomerUserRoleGroup'; uuid: string; name: string };
                  salesRepresentative: {
                      ...
                      telephone: string | null;
                      uuid: string;
                      image: { __typename?: 'Image'; url: string; name: string | null } | null;
                  } | null;
              }
            | {
        ...
        complaints: Array<{
            ...
            deliveryCountry: { __typename?: 'Country'; name: string };
            items: Array<{
                __typename: 'ComplaintItem';
                productName: string;
                quantity: number;
                description: string;
                orderItem: { __typename?: 'OrderItem'; uuid: string } | null;
            }>;
        }>;
    };
};
...
const result: PossibleTypesResultData = {
    possibleTypes: {
        ...
        CurrentCustomerUser: ['CurrentCompanyCustomerUser', 'CurrentRegularCustomerUser'],
        Hreflang: [
            'BlogArticle',
            'BlogCategory',
            'Brand',
