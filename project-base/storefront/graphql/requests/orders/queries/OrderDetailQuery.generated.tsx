...
export function useOrderDetailQuery(options?: Omit<Urql.UseQueryArgs<OrderDetailQueryVariables>, 'query'>) {
  return Urql.useQuery<OrderDetailQuery, OrderDetailQueryVariables>({ query: OrderDetailQueryDocument, ...options });
};