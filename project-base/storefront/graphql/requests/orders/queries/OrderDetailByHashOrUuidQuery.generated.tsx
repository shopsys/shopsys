...
export const OrderDetailByHashOrUuidQueryDocument = gql`
    query OrderDetailByHashOrUuidQuery($urlHash: String, $uuid: Uuid) {
  order(urlHash: $urlHash, uuid: $uuid) {
    ...OrderDetailFragment
  }
}
    ${OrderDetailFragment}`;

export function useOrderDetailByHashOrUuidQuery(options?: Omit<Urql.UseQueryArgs<TypeOrderDetailByHashOrUuidQueryVariables>, 'query'>) {
  return Urql.useQuery<TypeOrderDetailByHashOrUuidQuery, TypeOrderDetailByHashOrUuidQueryVariables>({ query: OrderDetailByHashOrUuidQueryDocument, ...options });
};