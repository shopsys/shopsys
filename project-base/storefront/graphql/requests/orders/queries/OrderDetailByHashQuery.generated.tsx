...
export function useOrderDetailByHashQuery(options?: Omit<Urql.UseQueryArgs<OrderDetailByHashQueryVariables>, 'query'>) {
  return Urql.useQuery<OrderDetailByHashQuery, OrderDetailByHashQueryVariables>({ query: OrderDetailByHashQueryDocument, ...options });
};