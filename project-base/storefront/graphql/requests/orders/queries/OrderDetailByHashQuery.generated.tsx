...
export type TypeOrderDetailByHashQuery = {
    __typename?: 'Query';
    order: {
        __typename: 'Order';
        uuid: string;
...
export function useOrderDetailByHashQuery(
    options?: Omit<Urql.UseQueryArgs<TypeOrderDetailByHashQueryVariables>, 'query'>,
) {
    return Urql.useQuery<TypeOrderDetailByHashQuery, TypeOrderDetailByHashQueryVariables>({
