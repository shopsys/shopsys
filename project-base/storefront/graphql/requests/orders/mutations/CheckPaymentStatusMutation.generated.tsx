...
export type CheckPaymentStatusMutationVariablesApi = Types.Exact<{
...
export function useCheckPaymentStatusMutationApi() {
    return Urql.useMutation<CheckPaymentStatusMutationApi, CheckPaymentStatusMutationVariablesApi>(
        CheckPaymentStatusMutationDocumentApi,
    );
}
