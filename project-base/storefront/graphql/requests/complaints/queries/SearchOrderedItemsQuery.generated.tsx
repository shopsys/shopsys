...
export const SearchOrderedItemsQueryDocument = gql`
    query SearchOrderedItemsQuery(
        $first: Int
        $after: String
        $searchInput: SearchInput!
        $filter: OrderItemsFilterInput
    ) {
...
export function useSearchOrderedItemsQuery(
    options: Omit<Urql.UseQueryArgs<TypeSearchOrderedItemsQueryVariables>, 'query'>,
) {
    return Urql.useQuery<TypeSearchOrderedItemsQuery, TypeSearchOrderedItemsQueryVariables>({
        query: SearchOrderedItemsQueryDocument,
        ...options,
    });
}
