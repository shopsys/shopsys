...
export type TypeComplaintQuery = {
    __typename?: 'Query';
    complaint: {
        ...
        status: string;
        deliveryCountry: { __typename: 'Country'; name: string; code: string };
        items: Array<{
            ...
            files: Array<{ __typename: 'File'; anchorText: string; url: string }> | null;
        }>;
        order: {
            __typename: 'Order';
            uuid: string;
...
export function useComplaintQuery(options: Omit<Urql.UseQueryArgs<TypeComplaintQueryVariables>, 'query'>) {
    return Urql.useQuery<TypeComplaintQuery, TypeComplaintQueryVariables>({
        query: ComplaintQueryDocument,
        ...options,
    });
}
