...
export type AutocompleteSearchQueryVariables = Types.Exact<{
...
export function useAutocompleteSearchQuery(options: Omit<Urql.UseQueryArgs<AutocompleteSearchQueryVariables>, 'query'>) {
  return Urql.useQuery<AutocompleteSearchQuery, AutocompleteSearchQueryVariables>({ query: AutocompleteSearchQueryDocument, ...options });
};