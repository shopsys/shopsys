...
export type TypeReorderProductListMutationVariables = Exact<{
  input: Types.TypeProductListReorderInput;
}>;


export type TypeReorderProductListMutation = { ReorderProductList: { __typename: 'ProductList', uuid: string, products: Array<
...
export const ReorderProductListMutationDocument = gql`
    mutation ReorderProductListMutation($input: ProductListReorderInput!) {
  ReorderProductList(input: $input) {
    ...ProductListFragment
  }
}
    ${ProductListFragment}`;

export function useReorderProductListMutation() {
  return Urql.useMutation<TypeReorderProductListMutation, TypeReorderProductListMutationVariables>(ReorderProductListMutationDocument);
};