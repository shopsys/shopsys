...
export function useRemoveProductFromListMutation() {
  return Urql.useMutation<RemoveProductFromListMutation, RemoveProductFromListMutationVariables>(RemoveProductFromListMutationDocument);
};