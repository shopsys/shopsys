...
export function useAddProductToListMutation() {
  return Urql.useMutation<AddProductToListMutation, AddProductToListMutationVariables>(AddProductToListMutationDocument);
};