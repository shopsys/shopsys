...
export type TypeAddProductToListMutationVariables = Exact<{
  input: Types.TypeProductListUpdateInput;
}>;


export type TypeAddProductToListMutation = { AddProductToList: { __typename: 'ProductList', uuid: string, products: Array<
