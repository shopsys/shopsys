...
export type BrandDetailQueryVariables = Types.Exact<{
...
export function useBrandDetailQuery(options?: Omit<Urql.UseQueryArgs<BrandDetailQueryVariables>, 'query'>) {
  return Urql.useQuery<BrandDetailQuery, BrandDetailQueryVariables>({ query: BrandDetailQueryDocument, ...options });
};