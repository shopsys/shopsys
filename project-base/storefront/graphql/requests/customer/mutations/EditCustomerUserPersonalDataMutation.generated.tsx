...
export type TypeEditCustomerUserPersonalDataInput = {
  /** UUID */
  customerUserUuid?: string | null | undefined;
...
export type TypeEditCustomerUserPersonalDataMutationVariables = Exact<{
  input: Types.TypeEditCustomerUserPersonalDataInput;
}>;


export type TypeEditCustomerUserPersonalDataMutation = { EditCustomerUserPersonalData:
