...
import { TypeVideoTokenFragment } from 'graphql/requests/products/fragments/VideoTokenFragment.ssr';
                        ...
                        {galleryItems.map((galleryItem, index) => {
                            ...
                            return (
                                <li
                                    key={index}
                                    className={twJoin(
                                        'outline-borderAccent vl:w-auto flex w-1/5 cursor-pointer items-center justify-center rounded-lg outline-1 hover:outline sm:h-16',
