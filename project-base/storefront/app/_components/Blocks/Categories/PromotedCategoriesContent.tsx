import { getPromotedCategoriesQuery } from 'app/_queries/getPromotedCategoriesQuery';
...
export const PromotedCategoriesContent: FC = async () => {
    const [t, promotedCategoriesData] = await Promise.all([getTranslation(), getPromotedCategoriesQuery()]);
