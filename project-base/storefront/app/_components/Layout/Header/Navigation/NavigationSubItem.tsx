...
import { TypeColumnCategoriesFragment } from 'graphql/requests/navigation/fragments/ColumnCategoriesFragment.ssr';
...
export const NavigationSubItem: FC<NavigationSubItemProps> = ({
    className,
    columnCategories,
    skeletonType,
    onLinkClick,
