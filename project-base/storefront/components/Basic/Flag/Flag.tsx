...
export const Flag: FC<FlagProps> = ({ children, href, className, type = 'custom' }) => {
    ...
    const flagTwClass = twMergeCustom(
        ...
        className,
        type === 'blog' &&
            'bg-text-subtle font-secondary font-semiBold text-xs !text-text-inverted no-underline hover:bg-background-accent-more hover:text-text-inverted hover:!no-underline',
