            ...
            <div
                className={twJoin(
                    ...
                    sliderItems.length > 4 &&
                        "vl:after:absolute vl:after:right-0 vl:after:top-0 vl:after:block vl:after:h-full vl:after:w-3 vl:after:bg-background-dark vl:after:bg-linear-to-r/srgb vl:after:from-background-defaultvl:after:to-transparent vl:after:opacity-25 vl:after:content-['']",
                )}
            >
                <div
                    className={twJoin(
