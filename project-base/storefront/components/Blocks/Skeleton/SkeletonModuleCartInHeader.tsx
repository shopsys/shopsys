...
export const SkeletonModuleCartInHeader: FC = () => {
    ...
    return (
        <div className="order-3 vl:order-4 flex">
            <div className="vl:flex hidden h-11 min-w-37 cursor-pointer items-center justify-center gap-x-3 rounded-lg border border-button-primary-text-default px-3 text-button-primary-text-default no-underline transition-all hover:no-underline group-hover:shadow-lg">
