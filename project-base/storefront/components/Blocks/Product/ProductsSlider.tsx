        ...
        <div className="relative" tid={tid}>
            ...
            <div ref={sliderRef}>
                <ProductsListContent
                    ...
                    className={twMergeCustom([
                        "grid snap-x snap-mandatory auto-cols-[80%] grid-flow-col overflow-x-auto overscroll-x-contain [-ms-overflow-style:'none'] [scrollbar-width:'none'] md:auto-cols-[45%] [&::-webkit-scrollbar]:hidden",
                        isBlogPage
