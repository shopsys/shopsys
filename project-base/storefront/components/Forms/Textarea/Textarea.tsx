        ...
        return (
            <LabelWrapper htmlFor={id} inputType="textarea" label={label} required={required}>
                <textarea
                    ...
                    className={twJoin(
                        'peer w-full resize-y appearance-none rounded-md border-2 border-inputBorder bg-inputBackground py-5 px-[10px] text-inputText placeholder:opacity-0 focus:outline-none disabled:pointer-events-none disabled:cursor-no-drop disabled:opacity-50',
