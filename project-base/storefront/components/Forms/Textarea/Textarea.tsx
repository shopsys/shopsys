        ...
        return (
            <LabelWrapper htmlFor={id} inputType="textarea" label={label} required={required}>
                <textarea
                    ...
                    className={twJoin(
                        'peer border-input-border-default bg-input-bg-default text-input-text-default hover:border-input-border-hovered focus:border-input-fill w-full resize-y appearance-none rounded-md border-2 px-[10px] py-5 font-bold placeholder:opacity-0 focus:outline-none disabled:pointer-events-none disabled:cursor-no-drop disabled:opacity-50',
