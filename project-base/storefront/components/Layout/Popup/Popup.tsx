        ...
        <div key={key}>
            ...
            <div
                ...
                className={twMergeCustom(
                    'fixed top-1/2 left-1/2 z-aboveOverlay flex max-h-full max-w-screen-lg -translate-x-1/2 -translate-y-1/2 cursor-auto flex-col rounded bg-white p-1 shadow-2xl transition-opacity',
                    className,
                )}
                onMouseDown={(event) => {
