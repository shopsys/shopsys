        ...
        <div key={key}>
            ...
            <div
                ...
                className={twMergeCustom(
                    'fixed top-1/2 left-1/2 z-aboveOverlay flex max-h-full max-w-screen-lg -translate-x-1/2 -translate-y-1/2 cursor-auto flex-col rounded bg-whiteSnow p-1 shadow-2xl transition-opacity',
                    className,
                )}
                onMouseDown={(event) => {
            ...
            >
                {!hideCloseButton && (
                    <div className="flex h-9 items-center justify-end ">
                        <button
                            className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-0 bg-whiteSnow text-xs text-skyBlue no-underline outline-none"
