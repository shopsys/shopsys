    ...
    return (
        <div className="relative mb-11 flex items-center lg:mb-24">
            <Image
                ...
                src={needAdviceImage}
            />
            <div className="relative ml-16 flex flex-1 flex-col items-start rounded bg-primaryDark p-4 before:absolute before:-left-1 before:-bottom-1 before:h-6 before:w-4 before:rounded-bl before:bg-primaryDark before:content-[''] before:[transform:rotate(0deg)skewX(-41deg)scale(1.414,0.707)] lg:ml-24 lg:flex-row lg:items-center lg:justify-between lg:py-5 lg:pr-5 lg:pl-8">
                ...
                <div className="mb-6 flex flex-wrap items-center lg:mb-0 lg:mr-2 lg:flex-1 vl:justify-center">
                    <PhoneIcon className="mr-3 w-5 text-secondary" />
                    <a
