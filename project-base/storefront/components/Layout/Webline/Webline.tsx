...
export const Webline: FC<WeblineProps> = ({ children, tid, wrapperClassName, className, width = 'xl' }) => {
    ...
    if (!wrapperClassName) {
        return (
            <section className={twMergeCustom(weblineClassName, className)} data-tid={tid} tabIndex={-1}>
                {children}
            </section>
        );
    }
    ...
    return (
        <section className={wrapperClassName}>
            <div className={twMergeCustom(weblineClassName, className)} data-tid={tid} tabIndex={-1}>
                {children}
            </div>
        </section>
    );
