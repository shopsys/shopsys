            ...
            <div className="col-start-1 row-start-1 grid grid-cols-[minmax(0,1fr)_auto] items-start gap-1">
                ...
                <div className="col-start-2 -mt-2 -mr-2 flex items-center gap-1">
                    {canReorder && (
                        <IconButton
                            Icon={DragHandleIcon}
                            className="cursor-grab touch-none opacity-100 pointer-fine:opacity-0 focus-visible:opacity-100 active:cursor-grabbing active:opacity-100 group-hover/comparison-product:opacity-100"
                            shape="rounded"
                            size="small"
