...
export const SearchProducts: FC = () => {
    ...
    const { searchProductsData, isFetching, loadMoreFetching } = useSearchProductsData();

    const title = useSeoTitleWithPagination(searchProductsData?.totalCount, t('Found products'));
