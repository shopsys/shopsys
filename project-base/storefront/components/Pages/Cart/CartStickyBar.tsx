...
export const CartStickyBar: FC<CartStickyBarProps> = ({ originalButtonRef }) => {
    ...
    return (
        <div
            className={`vl:fixed vl:right-0 vl:bottom-0 vl:left-0 vl:z-floatingAction bg-background-default shadow-[0_-4px_16px_rgba(0,0,0,0.1)] transition-transform duration-300 ${
                isEndOfList ? 'pointer-events-none translate-y-full' : 'pointer-events-auto translate-y-0'
            }`}
        >
            <Webline width="xl">
