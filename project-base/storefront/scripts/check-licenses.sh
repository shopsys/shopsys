...
BASIC_LICENSES="0BSD,Apache-2.0,Artistic-1.0,BlueOak-1.0.0,BSD*,BSD-2-Clause,BSD-3-Clause,CC-BY-3.0,CC-BY-4.0,CC0-1.0,ISC,MIT,MIT*,Python-2.0,UNLICENSED,WTFPL"
