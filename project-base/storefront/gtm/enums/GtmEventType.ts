export enum GtmEventType {
    ...
    add_to_wishlist = 'ec.add_to_wishlist',
    remove_from_wishlist = 'ec.remove_from_wishlist',
    add_to_comparison = 'ec.add_to_comparsion',
    remove_from_comparison = 'ec.remove_from_comparsion',
