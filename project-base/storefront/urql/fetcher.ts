...
export const fetcher =
    ...
    async (input: URL | RequestInfo, init?: RequestInit | undefined): Promise<Response> => {
        ...
        try {
            console.log('🔍 [GraphQL Redis] Checking for cache directive in body:', init.body);
            ...
            console.log('🔍 [GraphQL Redis] Cache lookup result:', { 
                ...
                cacheDataPreview: fromCache ? fromCache.substring(0, 100) + '...' : null
            });
            ...
            if (fromCache !== null) {
                ...
                try {
                    ...
                    console.error('❌ [GraphQL Redis] Raw cached data:', fromCache);
