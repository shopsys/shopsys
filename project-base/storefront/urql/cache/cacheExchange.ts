...
export const cache = cacheExchange({
    ...
    keys: {
        ...
        Cart: keyUuid,
        CartItem: keyUuid,
        CartGiftVoucherModificationsResult: keyNull,
        ...
        Product: keyUuid,
        ProductDeliveryOption: keyNull,
        ProductDeliveryStore: keyNull,
        ProductFilterOptions: keyNull,
        ProductPrice: keyNull,
        ProductReview: keyUuid,
        ProductReviewRatingCount: keyNull,
        ProductReviewsSummary: keyNull,
        ProductsByTransportUnavailabilityReason: keyNull,
        PromoCode: keyCode,
        ...
        UpdatePaymentStatusResult: keyNull,
    },
