...
check-fix: generate-schema markdown-fix php-checks php-translations storefront-checks storefront-knip storefront-translations storefront-styles-for-admin check-licenses ## Runs all code checks (backend & storefront) and attempts to fix issues
