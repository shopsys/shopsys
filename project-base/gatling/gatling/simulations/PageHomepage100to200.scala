...
class PageHomepage100to200 extends Simulation {
    ...
    val scn = scenario("Homepage 100→200 Users")
        .exec(http("homepage_100_to_200")
        .get("/"))

    setUp(
      scn.inject(
        rampUsers(100) during(20.seconds),           // Ramp up to 100 users over 20s
        constantUsersPerSec(200) during(25.seconds), // Stay at 200 users for 25s
