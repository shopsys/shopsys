...
class PageHomepage25to50 extends Simulation {
    ...
    val scn = scenario("Homepage 25→50 Users")
        .exec(http("homepage_25_to_50")
        .get("/"))

    setUp(
      scn.inject(
        rampUsers(25) during(20.seconds),           // Ramp up to 25 users over 20s
        constantUsersPerSec(50) during(25.seconds), // Stay at 50 users for 25s
