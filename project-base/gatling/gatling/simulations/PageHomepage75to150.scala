...
class PageHomepage75to150 extends Simulation {
    ...
    val scn = scenario("Homepage 75→150 Users")
        .exec(http("homepage_75_to_150")
        .get("/"))

    setUp(
      scn.inject(
        rampUsers(75) during(20.seconds),            // Ramp up to 75 users over 20s
        constantUsersPerSec(150) during(25.seconds), // Stay at 150 users for 25s
