...
class RouteConfigCustomization
{
    ...
    private function filterRoutesForTesting(RouteConfigCustomizer $routeConfigCustomizer): void
    {
        $routeConfigCustomizer
            ...
            ->customizeByRouteName('admin_feed_schedule', function (RouteConfig $config): void {
            ...
            ->customizeByRouteName('admin_administrator_set-new-password', function (RouteConfig $config): void {
    ...
    private function configureAdminRoutes(RouteConfigCustomizer $routeConfigCustomizer): void
    {
        $routeConfigCustomizer
            ...
            ->customizeByRouteName(['admin_customeruser_loginascustomeruser'], function (RouteConfig $config): void {
            ...
            ->customizeByRouteName('admin_localization_selectlocale', function (RouteConfig $config): void {
            ...
            ->customizeByRouteName('admin_administrator_send-reset-password', function (RouteConfig $config): void {
            ...
            ->customizeByRouteName('admin_administratorrolegroup_edit', function (RouteConfig $config): void {
                $config->changeDefaultRequestDataSet('First two role groups are system managed, so they can not be edited.')
                    ->setParameter('id', 3)
                    ->setExpectedStatusCode(200);
            })
            ->customizeByRouteName('admin_administratorrolegroup_copy', function (RouteConfig $config): void {
     ...
     * @return T
     */
    private function getPersistentReference(string $name, ?int $domainId = null, ?string $entityClassName = null)
    {
