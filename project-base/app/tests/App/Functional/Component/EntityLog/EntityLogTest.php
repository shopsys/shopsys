...
class EntityLogTest extends TransactionFunctionalTestCase
{
    ...
    public function testEditEntity(): void
    {
        ...
        $expectedOldStatusName = $orderFromDb->getStatus()->getName($this->localization->getLocale());
        ...
        $this->assertSame($newStatus->getName($this->localization->getLocale()), $log->getChangeSet()['status']['newReadableValue']);
    }
