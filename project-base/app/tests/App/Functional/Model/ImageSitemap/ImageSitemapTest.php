...
class ImageSitemapTest extends ApplicationTestCase
{
    ...
    private function getExpectedXmlRegex(DomainConfig $domainConfig): string
    {
        ...
        return '~<url><loc>' . $urlPattern . '/' . $television . '-22-sencor-sle-22f46dm4-hello-kitty-' . $plasma . '</loc><image\:image><image\:loc>' . $urlPattern . '/content-test/images/product/original/22-sencor-sle-22f46dm4-hello-kitty_1\.jpg</image\:loc><image\:title><!\[CDATA\[22" Sencor SLE 22F46DM4 HELLO KITTY\]\]></image\:title></image\:image></url>~';
    }
    ...
    private function getUnexpectedNotMainXml(DomainConfig $domainConfig): string
    {
        ...
        return '<url><loc>' . $url . '/televize-22-sencor-sle-22f46dm4-hello-kitty-plazmova</loc><image:image><image:loc>' . $url . '/content/images/product/original/22-sencor-sle-22f46dm4-hello-kitty_64.jpg</image:loc><image:title><![CDATA[22" Sencor SLE 22F46DM4 HELLO KITTY]]></image:title></image:image></url>';
    }
