 ...
 * @method \App\Model\Order\Order[] getCustomerUserOrderLimitedList(\App\Model\Customer\User\CustomerUser $customerUser, int $limit, int $offset, \Shopsys\FrontendApiBundle\Model\Order\OrderFilter|null $filter = null)
