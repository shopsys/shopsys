 ...
 * @method \App\Model\Category\Category[] getVisibleCategoriesInPathFromRootOnDomain( $category, int $domainId)
 ...
 * @method \App\Model\Category\Category[] getAllVisibleChildrenByCategoryAndDomainId( $category, int $domainId)
 * @method \App\Model\Category\Category[]|null[] getProductMainCategoriesIndexedByDomainId( $product)
 * @method \App\Model\Category\Category getProductMainCategoryByDomainId( $product, int $domainId)
 * @method \App\Model\Category\Category|null findProductMainCategoryByDomainId( $product, int $domainId)
 ...
 * @method int[] getListableProductCountsIndexedByCategoryId(\App\Model\Category\Category[] $categories,  $pricingGroup, int $domainId)
 * @property \Shopsys\FrameworkBundle\Component\Domain\Domain $domain
 * @property \App\Component\Image\ImageFacade $imageFacade
 * @method \App\Model\Category\Category[] getAllTranslated( $locale)
 * @method \App\Model\Category\Category[] getAllTranslatedWithoutBranch( $category,  $locale)
 ...
 * @method \App\Model\Category\Category[] getCategoriesOfProductByFilterData( $productFilterData)
 ...
 * @method \App\Model\Category\Category create( $categoryData)
 * @method \App\Model\Category\Category edit(int $categoryId,  $categoryData)
 */
