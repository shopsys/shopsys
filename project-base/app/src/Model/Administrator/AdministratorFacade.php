 ...
 * @method __construct(\Doctrine\ORM\EntityManagerInterface $em, \App\Model\Administrator\AdministratorRepository $administratorRepository, \Shopsys\FrameworkBundle\Model\Administrator\AdministratorFactory $administratorFactory, \App\Model\Administrator\Role\AdministratorRoleFacade $administratorRoleFacade, \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface $tokenStorage, \Psr\Clock\ClockInterface $clock, \Shopsys\FrameworkBundle\Model\Administrator\CurrentAdministrator $currentAdministrator)
 * @method void setAdministratorTransferIssuesLastSeenDateTime(\App\Model\Administrator\Administrator $administrator)
