 ...
 * @method \App\Model\Payment\Payment create( $paymentData)
 ...
 * @method \App\Model\Payment\Payment[] getVisibleOnCurrentDomainByTransport( $transport)
 * @method \App\Model\Payment\Payment[] getVisibleForOrder( $order)
 * @method \App\Model\Payment\Payment[] getVisibleOnDomainByTransport( $domainId,  $transport)
