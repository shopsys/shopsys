 ...
 * @method void edit(\App\Model\Transport\Transport $transport, \App\Model\Transport\TransportData $transportData)
 ...
 * @method void updateTransportPrices(\App\Model\Transport\Transport $transport, \Shopsys\FrameworkBundle\Model\Transport\TransportInputPricesData[] $inputPricesDataIndexedByDomainId)
 * @method \App\Model\Transport\Transport[] getAllIncludingDeleted()
 * @method \Shopsys\FrameworkBundle\Model\Pricing\PriceInterface[][] getIndependentBasePricesIndexedByDomainId(\App\Model\Transport\Transport $transport)
 * @method \Shopsys\FrameworkBundle\Model\Pricing\PriceInterface[] getPricesIndexedByTransportPriceId(\App\Model\Transport\Transport $transport)
