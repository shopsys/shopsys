 ...
 * @method createFriendlyUrlsWhenRenamed(\App\Model\Product\Product $product, string[] $originalNames)
 * @method string[] getChangedNamesByLocale(\App\Model\Product\Product $product, string[] $originalNames)
 */
