 ...
 * @method \App\Model\Customer\User\CustomerUser create( $customerUserUpdateData)
 ...
 * @method \App\Model\Customer\User\CustomerUser editByAdmin( $customerUserId,  $customerUserUpdateData)
 * @method \App\Model\Customer\User\CustomerUser editByCustomerUser( $customerUserId,  $customerUserUpdateData,  $deviceId = null)
 ...
 * @method \App\Model\Customer\User\CustomerUser edit( $customerUserId,  $customerUserUpdateData,  $deliveryAddress = null,  $deviceId = null)
 * @method addRefreshTokenChain(\App\Model\Customer\User\CustomerUser $customerUser, string $refreshTokenChain, string $deviceId, \DateTimeImmutable $tokenExpiration, \App\Model\Administrator\Administrator|null $administrator)
 ...
 * @method \App\Model\Customer\User\CustomerUser createWithActivationMail( $customerUserUpdateData)
