 ...
 * @method void sendRegistrationMail(\App\Model\Customer\User\CustomerUser $customerUser)
 ...
 * @method void sendRegistrationMailTemplate(\App\Model\Mail\MailTemplate $mailTemplate, \App\Model\Customer\User\CustomerUser $customerUser, string|null $forceSendTo = null)
 * @method void sendActivationMailTemplate(\App\Model\Mail\MailTemplate $mailTemplate, \Shopsys\FrameworkBundle\Component\Security\ResetPasswordInterface $customerUser, string|null $forceSendTo = null)
 */
