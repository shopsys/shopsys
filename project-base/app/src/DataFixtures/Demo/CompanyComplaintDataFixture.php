...
class CompanyComplaintDataFixture extends AbstractReferenceFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $uploadedFile1 = $this->complaintHelper->createUploadedFiles(__DIR__ . '/../resources/images/complaint/404.jpg');
        $uploadedFile2 = $this->complaintHelper->createUploadedFiles(__DIR__ . '/../resources/images/complaint/405.jpg');

        $order27 = $this->getReference(CompanyOrderDataFixture::ORDER_PREFIX . 27, Order::class);
        $orderItems1 = $order27->getProductItems();
        $orderItem1 = $this->complaintHelper->createComplaintItemData(array_shift($orderItems1), 'Broken!', 1, [$uploadedFile2]);
        ...
        $orderItem1 = $this->complaintHelper->createComplaintItemData(array_shift($orderItems1), 'Broken!', 1, [$uploadedFile1]);
