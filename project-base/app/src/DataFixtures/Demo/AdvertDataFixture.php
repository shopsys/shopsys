...
{
    public const string FOOTER_ADVERT_REFERENCE_PREFIX = 'footer_advert_';
    public const string CATEGORY_ADVERT_REFERENCE_PREFIX = 'category_advert_';
    ...
    public function load(ObjectManager $manager): void
    {
        foreach ($this->domainsForDataFixtureProvider->getAllowedDemoDataDomains() as $domainConfig) {
            ...
            $advertData->type = Advert::TYPE_IMAGE;
            $advertData->hidden = false;
            $advertData->positionName = AdvertPositionRegistry::POSITION_CATEGORIES_SECOND_ROW_PRODUCT_LIST;
            ...
            $categoryAdvert = $this->advertFacade->create($advertData);
            $this->addReference(self::CATEGORY_ADVERT_REFERENCE_PREFIX . $domainId, $categoryAdvert);
        }
    }
