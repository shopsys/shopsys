...
function deploy() {
    ...
    declare -A ENVIRONMENT_VARIABLES=(
        ...
        ["PERSOO_ACCOUNT_ID"]=${PERSOO_ACCOUNT_ID}
        ["PERSOO_IS_PRODUCTION_MODE"]=${PERSOO_IS_PRODUCTION_MODE}
        ["PERSOO_ENABLED_DOMAIN_IDS"]=${PERSOO_ENABLED_DOMAIN_IDS}
        ["PERSOO_RECOMMENDATION_ALGORITHM_ID"]=${PERSOO_RECOMMENDATION_ALGORITHM_ID}
        ["PERSOO_RECOMMENDATION_OFFER_ID"]=${PERSOO_RECOMMENDATION_OFFER_ID}
        ["PERSOO_RECOMMENDATION_LOCATION_ID"]=${PERSOO_RECOMMENDATION_LOCATION_ID}
        ["PERSOO_SEARCH_ALGORITHM_ID"]=${PERSOO_SEARCH_ALGORITHM_ID}
        ["PERSOO_SEARCH_OFFER_ID"]=${PERSOO_SEARCH_OFFER_ID}
        ["PERSOO_SEARCH_LOCATION_ID"]=${PERSOO_SEARCH_LOCATION_ID}
    )
