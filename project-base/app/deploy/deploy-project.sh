...
function deploy() {
    ...
    declare -A ENVIRONMENT_VARIABLES=(
        ...
        ["LUIGIS_BOX_ACCOUNT_ID"]=${LUIGIS_BOX_ACCOUNT_ID}
        ["LUIGIS_BOX_IS_PRODUCTION_MODE"]=${LUIGIS_BOX_IS_PRODUCTION_MODE}
        ["LUIGIS_BOX_ENABLED_DOMAIN_IDS"]=${LUIGIS_BOX_ENABLED_DOMAIN_IDS}
        ["LUIGIS_BOX_RECOMMENDATION_ALGORITHM_ID"]=${LUIGIS_BOX_RECOMMENDATION_ALGORITHM_ID}
        ["LUIGIS_BOX_RECOMMENDATION_OFFER_ID"]=${LUIGIS_BOX_RECOMMENDATION_OFFER_ID}
        ["LUIGIS_BOX_RECOMMENDATION_LOCATION_ID"]=${LUIGIS_BOX_RECOMMENDATION_LOCATION_ID}
        ["LUIGIS_BOX_SEARCH_ALGORITHM_ID"]=${LUIGIS_BOX_SEARCH_ALGORITHM_ID}
        ["LUIGIS_BOX_SEARCH_OFFER_ID"]=${LUIGIS_BOX_SEARCH_OFFER_ID}
        ["LUIGIS_BOX_SEARCH_LOCATION_ID"]=${LUIGIS_BOX_SEARCH_LOCATION_ID}
    )
