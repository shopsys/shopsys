...
function deploy() {
    ...
    declare -A ENVIRONMENT_VARIABLES=(
        ...
        ["MCP_DATABASE_USER"]=${MCP_DATABASE_USER:-}
        ["MCP_DATABASE_PASSWORD"]=${MCP_DATABASE_PASSWORD:-}
        ["ELASTICSEARCH_HOST"]=${ELASTICSEARCH_URLS}
        ["ELASTIC_SEARCH_INDEX_PREFIX"]=${PROJECT_NAME}
        ["REDIS_PREFIX"]=${PROJECT_NAME}
        ["MAILER_DSN"]=${MAILER_DSN}
        ["MESSENGER_TRANSPORT_DSN"]=${MESSENGER_TRANSPORT_DSN}
        ["GOTENBERG_DSN"]=${GOTENBERG_DSN:-'http://gotenberg:3000'}
        ...
        ["LUIGIS_BOX_API_URL"]=${LUIGIS_BOX_API_URL}
