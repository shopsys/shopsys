...
Create new project on Shopsys Framework easily from this package following the [Installation Guide](https://docs.shopsys.com/en/9.0/installation/installation-guide/).
