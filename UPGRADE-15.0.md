...
#### update elastic structure ([#2567](https://github.com/shopsys/shopsys/pull/2567))

-   some cosmetic changes were added. If you don't want to apply it, so skip this change
    -   elastic config was sorted by repository
    -   added missing properties and remove unnecessary properties from elastic structure
    -   changed indent count for json files
-   see #project-base-diff to update your project
