    ...
    public function up(Schema $schema): void
    {
        ...
        foreach ($parameterValues as $parameterValue) {
            ...
            foreach ($parameterValuesWithoutRgbHex as $parameterValueWithoutRgbHex) {
                $productParameterValues = $this->sql(
                    'SELECT product_id, parameter_id, value_id FROM product_parameter_values WHERE value_id = :parameterValueWithoutRgbHexId',
                ...
                $this->sql(
                    'DELETE FROM parameter_values WHERE id = :parameterValueId',
