...
class ReadyCategorySeoMixGridFactory
{
    ...
    public function create(int $domainId, string $locale): Grid
    {
        ...
        $grid->addDeleteActionColumn('admin_categoryseo_delete', ['id' => 'rcsm.id']);
    ...
    public function getAllByDomainIdQueryBuilder(int $domainId, string $locale): QueryBuilder
    {
        return $this->em->createQueryBuilder()
            ->select('rcsm.id, c.id as categoryId, ct.name as categoryName, fu.slug, rcsm.choseCategorySeoMixCombinationJson, ft.name as flagName, rcsm.ordering')
