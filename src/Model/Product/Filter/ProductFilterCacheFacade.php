...
class ProductFilterCacheFacade
{
     ...
     */
    public function setProductFilterCountDataIntoCache(ProductFilterCountData $productFilterCountData, int $categoryId, int $domainId, ?ReadyCategorySeoMix $readyCategorySeoMix): void
    {
     ...
     */
    public function findProductFilterCountDataInCache(int $categoryId, int $domainId, ?ReadyCategorySeoMix $readyCategorySeoMix): ?ProductFilterCountData
    {
        $cacheId = $this->getCacheId($categoryId, $domainId, $readyCategorySeoMix);
     ...
     * @return string
     */
    private function getCacheId(int $categoryId, int $domainId, ?ReadyCategorySeoMix $readyCategorySeoMix): string
    {
