...
class ProductDataFixture extends AbstractReferenceFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->setFlags($productData, [FlagDataFixture::FLAG_PRODUCT_SALE, FlagDataFixture::FLAG_PRODUCT_ACTION, FlagDataFixture::FLAG_PRODUCT_SCONTO]);
        ...
        $this->setAvailability($productData, AvailabilityDataFixture::AVAILABILITY_IN_STOCK);
        $this->setCategoriesForAllDomains($productData, [CategoryDataFixture::CATEGORY_ELECTRONICS, CategoryDataFixture::CATEGORY_TV]);
        $this->setFlags($productData, [FlagDataFixture::FLAG_PRODUCT_SALE, FlagDataFixture::FLAG_PRODUCT_ACTION]);
