...
final class CreateAndCommitLockFilesReleaseWorker extends AbstractShopsysReleaseWorker
{
    ...
    public function work(Version $version): void
    {
        ...
        $this->symfonyStyle->note([
            ...
            'You have to allow push to the protected branch here https://github.com/shopsys/shopsys/settings/branches first and turn of "status checks to pass before merging"',
        ]);
