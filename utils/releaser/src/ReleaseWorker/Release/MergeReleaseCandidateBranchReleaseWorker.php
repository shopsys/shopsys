...
final class MergeReleaseCandidateBranchReleaseWorker extends AbstractShopsysReleaseWorker
{
    ...
    public function work(Version $version): void
    {
        ...
        if ($this->initialBranchName === 'master') {
            ...
            $this->symfonyStyle->note(sprintf('You need split the "%s" branch it using "tool-monorepo-force-split-branch" on Heimdall (http://heimdall:8080/view/Tools/job/tool-monorepo-split-branch/)', $this->initialBranchName));
        }
