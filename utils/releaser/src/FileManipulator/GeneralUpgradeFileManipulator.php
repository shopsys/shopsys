...
{
    private const FROM_PREVIOUS_TO_NEXT_DEV_LINK_PATTERN = '#^\* \#\#\# \[From [\w.-]+ to [\w.-]+-dev\]\(\.\/docs\/upgrade\/UPGRADE-[\w.-]+-dev\.md\)$#m';
    ...
    {
        $newLink = sprintf('* ### [From %s to %2$s](./docs/upgrade/UPGRADE-%2$s.md)' . PHP_EOL, $version->getVersionString(), $nextDevelopmentVersionString);
