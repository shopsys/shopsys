...
PATH_CONFIG_DOMAIN_URL='/var/www/html/project-base/app/config/domains_urls.yml'
PATH_CONFIG_PARAMETERS='/var/www/html/project-base/app/config/parameters.yml'
...
VARS=(
    ...
    PATH_CONFIG_DOMAIN_URL
    PATH_CONFIG_PARAMETERS
    GOOGLE_CLOUD_STORAGE_BUCKET_NAME
    GOOGLE_CLOUD_PROJECT_ID
)
