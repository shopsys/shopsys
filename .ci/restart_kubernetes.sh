...
kubectl exec --namespace=${JOB_NAME} ${PHP_FPM_POD} -- ./phing -D production.confirm.action=y clean dirs-create backend-api-install backend-api-oauth-keys-generate elasticsearch-index-recreate elasticsearch-export grunt error-pages-generate
