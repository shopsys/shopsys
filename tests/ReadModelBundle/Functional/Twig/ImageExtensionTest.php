...
class ImageExtensionTest extends FunctionalTestCase
{
    ...
    public function testGetImageHtml(): void
    {
        ...
        $expected .= sprintf('    <source media="only screen and (min-width: 769px) and (-webkit-min-device-pixel-ratio: 1.5)" srcset="%s/content-test/images/product/default/additional_1_1.jpg"/>', $this->getCurrentUrl());
